...
class IAN(tf.keras.Model):
    ...
    def __init__(self, config):
        ...
        self.aspect_w = tf.contrib.eager.Variable(tf.random.normal([self.n_hidden, self.n_hidden]), name='aspect_w')
        self.aspect_b = tf.contrib.eager.Variable(tf.zeros([self.n_hidden]), name='aspect_b')
        self.context_w = tf.contrib.eager.Variable(tf.random.normal([self.n_hidden, self.n_hidden]), name='context_w')
